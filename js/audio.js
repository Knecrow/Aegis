...
class HUDAudioEngine {
  ...
  /** Dual-tone chime — persona switch */
  toggle() {
    this._playTone({ frequency: 580, type: 'sine', gain: 0.2, duration: 0.13, attack: 0.01 });
    this._playTone({ frequency: 880, type: 'sine', gain: 0.2, duration: 0.14, attack: 0.008, delay: 0.11 });
  }
